...
namespace TheWitcher
{
    public partial class FormT5 : Form
    {
        ...
        public Test test;
        string path = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\TheWitcherBook\T5.txt";
        ...
        public FormT5()
        {
            ...
            else test = new Test(panelTest, panelText, buttonEnd, Properties.Resources.T5);
            test.LayoutTest();
        }

        private void FormT5_Load(object sender, EventArgs e)
        {
            if (isTest)
            {
                test.ShowTest(true);
