...
{
    public partial class FormT2 : Form // Форма с тестом как и все
    {
        ...
        public Test test;
        string path = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\TheWitcherBook\T2.txt";
        ...
        public FormT2()
        {
            ...
            else test = new Test(panelTest, panelText, buttonEnd, Properties.Resources.T2);
            test.LayoutTest();
        }
